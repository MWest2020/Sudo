...
const int vel = 60, vel_Back = 45;                   //vel(mid), delay_Forward(mid) = (20, 750) 
const int delay_Forward = 200, delay_Back = 250;     //vel(max), delay_Forward(min)= (256, 50)
                                                     //wonderful ---> (10, 700) (50, 500) (100, 100) (100, 300) (100, 500)

int vel_Dance1 = 80,    vel_Dance2 = 55,    vel_Dance3 = 70;     //30, 25, 40
int delay_Dance1 = 150, delay_Dance2 = 350, delay_Dance3 = 100;  //300, 750, 200

int vel_Dance4 = 40,    vel_Dance5 = 40,    vel_Dance6 = 30;
int delay_Dance4 = 400, delay_Dance5 = 400, delay_Dance6 = 500;

const int array_cal[4] = {135,55,140,65};    //106,94,80,96
